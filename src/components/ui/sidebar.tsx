...
>(({ className, onClick, children, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props} // This will pass `asChild` if present
    >
      {/* If 'asChild' is true (coming from props), then props.children should be rendered.
...
>(({ className, ...props }, ref) => {
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "h-8 w-full bg-background/70 shadow-none focus-visible:ring-2 focus-visible:ring-sidebar-ring backdrop-blur-sm",
        className
      )}
      {...props}
    />
